...
export function AppointmentCreate() {
    ...
    function handleSave() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const storage = yield AsyncStorage.getItem(COLLECTION_APPOINTMENTS);
            const appointments = storage ? JSON.parse(storage) : [];
            yield AsyncStorage.setItem(COLLECTION_APPOINTMENTS, JSON.stringify([...appointments, newAppointment]));
